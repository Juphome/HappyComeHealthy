package com.happycomehealthy.module.test.mydatepicker;
...
public class DatePicker2 extends LinearLayout {
    ...
    public interface OnDateTouchedListener {
        void onDateTouched(String yearMonth);
    }

    private OnDateSelectedListener onDateSelectedListener;// 日期多选后监听

    private OnDateTouchedListener onDateTouchedListener;// 日期多选后监听
    ...
    public DatePicker2(final Context context, AttributeSet attrs) {
        ...
        monthView.setOnDateScrollChangeListener(new MonthView.OnDateScrollChangeListener() {
            ...
            public void scrollLeft(int year, int month) {
                ...
                onDateTouchedListener.onDateTouched(year+"-"+month);
...
//                Toast.makeText(context,str,Toast.LENGTH_SHORT).show();
     ...
     */
    public void setOnDateSelectedListener(DatePicker2.OnDateSelectedListener onDateSelectedListener) {
     ...
     * 设置滑动的监听器
     *
     * @param onDateTouchedListener ...
     */
    public void setOnDateTouchedListener(DatePicker2.OnDateTouchedListener onDateTouchedListener) {

        this.onDateTouchedListener = onDateTouchedListener;
    }
